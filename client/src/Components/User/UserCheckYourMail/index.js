    ...
    <div className="check-your-mail-container">
      ...
      <Link to="/user/reset-password"> {/* Wrap the arrow with Link */}
        ...
        <div className="check-your-mail-email-link">
            ...
            <button className="check-your-mail-btn">Check your mail</button>
...
export default UserCheckYourMail;
